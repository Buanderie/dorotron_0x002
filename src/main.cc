...
//    dt0->set_property("steps", 4);
    ...
    {
        sleep(1);
//        int rbpm = 60 + rand() % 500;
//        sequencer.set_property( "bpm", rbpm );
    }
...
int main(void)
{
    ...
    Mesh torus = GenMeshTorus(0.00001, 20, 64, 64);
...
//                    DrawSphereBasic(GOLD);                              // Draw the Sun
                ...
                rlPushMatrix();
                rlRotatef(90.0, 1.0f, 0.0f, 0.0f);    // Rotation for Earth orbit around Sun
                DrawModel(model1, (Vector3){0,0,0}, 1, BLACK);
                rlPopMatrix();
            EndMode3D();
